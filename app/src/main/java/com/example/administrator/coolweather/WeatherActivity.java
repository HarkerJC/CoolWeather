...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            com.example.administrator.coolweather.gson.Weather weather=Utility.handleWeatherResponse(weatherString);
...
final  String bingPic=response.body().toString();
    ...
    {
        String weatherUrl="http://guolin.tech/api/weather?cityid="+weatherId+"&key=8fa098deb245460da3c7fb226ad83975 ";
...
final String responseText=response.body().string();
                final com.example.administrator.coolweather.gson.Weather weather= Utility.handleWeatherResponse(responseText);
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
    ...
    private  void showWeatherInfo(com.example.administrator.coolweather.gson.Weather weather)
    {
